...
const WhyChooseSection = () => {
  const features = [
    ...
    {
      icon: <Flame className="h-6 w-6 text-teal-600" />,
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex flex-col h-full rounded-xl border border-teal-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow duration-300"
              >
                <div
                ...
                <p className="text-teal-600 text-sm flex-grow">
                  {feature.description}
                </p>
                <div className="mt-4 pt-3 border-t border-teal-100 flex items-center text-teal-600 text-sm font-medium">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-12 bg-teal-100 rounded-xl p-8 shadow-sm"
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-start space-x-4">
                  <div className="mt-1">
                    <Quote className="text-teal-600 w-8 h-8 rotate-180" />
                  </div>
                  <div>
                    <p className="text-teal-700 italic mb-3">
                    ...
                    <p className="font-bold text-teal-900">Sarah L.</p>
              ...
              <div className="flex flex-col justify-center space-y-4 md:border-l md:border-teal-200 md:pl-6">
                <div className="text-center">
                  <p className="text-3xl font-bold text-teal-600">97%</p>
                  <p className="text-sm text-teal-600">Student satisfaction</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-teal-600">30+</p>
                  <p className="text-sm text-teal-600">Native teachers</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-bold text-teal-600">4.8/5</p>
                  <p className="text-sm text-teal-600">App store rating</p>
                </div>
              </div>
            </div>
          </motion.div>
