...
const HeroSection = () => {
  return (
    <section className="relative bg-gradient-to-b from-teal-50 to-white py-8 md:py-12">
        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-teal-900">
              Master <span className="text-teal-600">Chinese</span> with
              Confidence
            </h1>
            <p className="max-w-[600px] text-teal-600 md:text-xl">
            ...
            <div className="flex items-center space-x-4 pt-4">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="h-8 w-8 rounded-full bg-teal-100 border-2 border-white overflow-hidden"
                  >
                    <Image
              ...
              <div className="text-sm text-teal-600">
                <span className="font-bold text-teal-900">50K+</span> active
                learners
              </div>
            </div>
          </motion.div>
            ...
            <div className="absolute -bottom-6 -left-6 rounded-lg bg-white p-4 shadow-lg">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-teal-600">Speak from day one</p>
                </div>
              </div>
            </div>
